  ...
  <EventFiltering>
    ...
    <RuleGroup name="T1566.001-SpearphishingAttachment" groupRelation="or">
      <ProcessCreate onmatch="include">
        ...
        <ParentImage condition="end with">fuzzy.exe</ParentImage>
        <!-- TODO: Look for outlook.exe, thunderbird.exe and winmail.exe -->
    ...
    <RuleGroup name="T1204.001-MaliciousLink" groupRelation="or">
      <NetworkConnect onmatch="include">
        ...
        <!-- TODO: Add suspicious Destination ports for MaliciousLink, lookup MITRE ATT&CK Framework for the port number -->
    ...
    <RuleGroup name="T1566.001-T1204.001-FileCreation" groupRelation="or">
      <FileCreate onmatch="include">
       ...
       <!-- TODO: Add suspicious file which can create a reverse_tcp proxy through it's html application -->
...
$EmailProcesses = Get-WmiObject Win32_Process | Where-Object {
    ...
    # TODO: Change the "some-suspicious-process" to the actual process name you want to monitor
    if ($ParentProcess -and ($ParentProcess.Name -match "some-suspicious-process")) {
        [PSCustomObject]@{
            ProcessName = $_.Name
